...
## Introduction
This is a repo for small projects that can be used to practice data cleansing using SQL, Excel or any other method.  This small project was inspired by a post made by [Subham kuamr]() on LinkedIn.

### Project List:
- [Club Member Information](./club_member_info/README.md)
